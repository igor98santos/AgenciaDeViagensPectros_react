...
import img1 from "../imagens/Viagem dos sonhos/israel.jpg";
import img2 from "../imagens/Viagem dos sonhos/Rio de janeiro.jpg";
import img3 from "../imagens/Viagem dos sonhos/italia.jpg";
import img4 from "../imagens/Viagem dos sonhos/israel.jpg";
import img5 from "../imagens/cards de preço da home/Englaterra/englaterra 3.jpg";
import img6 from "../imagens/cards de preço da home/noruega/aurora-borealis-g3b9626256_640.jpg";
import img7 from "../imagens/Viajem em familia/Disney.jpg";
      ...
      <div className="container-fluid marketing ">
          ...
          <div className="col-md-3 ">
            <div className="card" style="width: 18rem;">
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">até 12x no cartão sem juros</li>
          ...
          <div className="col-md-3 ">
            <div className="card" style="width: 18rem;">
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">até 6x no cartão sem juros</li>
                <li className="list-group-item">Aproveite a oferta</li>
              </ul>
              <div className="card-body">
                <a href="#" className="card-link">
        ...
        <div className="row featurette">
          <div className="col-md-7 order-md-2">
            <h2 className="featurette-heading">Conheça o balneário camboriú</h2>
            <p className="lead">
          ...
          <div className="col-md-5 order-md-1">
            <img
              src="imagens/antes de viagem em familia/cabuiriu.jpg"
                ...
                <div className="content d-flex flex-column align-items-center justify-content-center">
                  <div>
                    ...
                    <div className="card-body">
                      ...
                      <Link href="tel:(11)979697722" tel className="card-link">
                        Entrar em Contato
                      </Link>
                    </div>
                  </div>
